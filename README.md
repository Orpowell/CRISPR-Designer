...
# WARNING BUG!: 60mer designs currently design sgRNA that targets the synonymous mutation site not the real mutation site. The bug is found in ALL versions
